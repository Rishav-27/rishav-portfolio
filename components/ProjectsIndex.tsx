...
export default function ProjectsIndex() {
  ...
  const shown =
    filter === "all"
      ? projects
      : projects.filter((p) => p.kind === KINDS[filter]);
  const tabs: { key: Key; label: string; count: number }[] = [
    { key: "all", label: "All", count: projects.length },
    {
      key: "team",
      label: "Client & team",
      count: projects.filter((p) => p.kind === "Team project").length,
    },
    {
      key: "personal",
      label: "Personal",
      count: projects.filter((p) => p.kind === "Personal project").length,
    },
    {
      key: "wip",
      label: "In progress",
      count: projects.filter((p) => p.kind === "In progress").length,
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        {navOpen && (
          ...
          >
            ...
            <Link href="/#experience" onClick={closeNav} style={navSheet}>
              Experience
            </Link>
            <Link href="/#building" onClick={closeNav} style={navSheet}>
              Building
            </Link>
            <Link href="/#skills" onClick={closeNav} style={navSheet}>
              Skills
            </Link>
            <Link href="/#github" onClick={closeNav} style={navSheet}>
              GitHub
            </Link>
      ...
      >
        ...
        >
          I&apos;ve also contributed to several client builds at WebbyWolf that
          aren&apos;t mine to publish — happy to talk through that work
          directly.
        </p>
          ...
          >
            {p.img ? (
              ...
              >
                ...
                >
                  {p.kind === "In progress" ? "BUILDING NOW" : "NO PREVIEW"}
                </div>
              </div>
            )}
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: 16, color: "var(--dim)" }}>
                  {p.kicker}
                </div>
              </div>
