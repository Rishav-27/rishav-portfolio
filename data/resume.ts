...
export const projects: Project[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Gemini-powered rewrite that tailors bullets and keywords to a pasted job description.",
      "ATS match score with keyword coverage and version history per rewrite.",
...
export const skills = [
  ...
  },
  {
    ...
    rest: ["Framer Motion", "Redux", "HTML5", "CSS3"],
  ...
  },
  {
    ...
    rest: ["Express", "MongoDB", "REST APIs", "WebSockets"],
  ...
  },
  {
    ...
    rest: ["Docker", "Postman", "CI/CD", "Agile", "System Design"],
...
export const building = [
  ...
  },
  {
    ...
    status: "LIVE",
    blurb:
      "AI-tailored, ATS-ready resumes — paste a job description, get rewritten bullets, a match score, and clean PDF export.",
    tech: ["Next.js", "Supabase", "AI SDK", "Puppeteer"],
  },
];

export const certifications = [
  {
    title: "$175 Blockchain Scholarship",
    issuer: "MetaCrafters",
    date: "2023",
  },
  {
